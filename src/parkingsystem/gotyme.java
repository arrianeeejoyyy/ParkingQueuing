 ...
 * @author Airi
 */
public class gotyme extends javax.swing.JFrame {
  ...
  public void setHoldPlate(String plate) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MAIN_UI/gotyme.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gotyme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
