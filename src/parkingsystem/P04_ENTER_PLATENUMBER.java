...
public class P04_ENTER_PLATENUMBER extends javax.swing.JFrame {
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if (confirmResult == JOptionPane.YES_OPTION) {
            // First, show the payment choice screen
            P05_CHOOSE_PAYMENT P05 = new P05_CHOOSE_PAYMENT();
            P05.setVisible(true);
            this.setVisible(false); // Hide current frame

            // Add a WindowListener to P05_CHOOSE_PAYMENT to wait for it to close
            P05.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                    // This code runs AFTER P05_CHOOSE_PAYMENT is closed
